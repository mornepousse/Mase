...
// Exemple simplifié, à remplacer par ton vrai tableau depuis SROM_PMW3389.ino
const uint8_t srom_firmware[] = {
...
const int srom_length = sizeof(srom_firmware);